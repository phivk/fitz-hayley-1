...
const demoPage1 = `<p>My dear Eliza</p><p>Your letter has indeed struck me with a double surprize. – of the first I shall not speak at present, because I feel perhaps a little too like
    the honest old servant, you mention, to relish it on the sudden</p><p>
    ...
    sea-bathing this Autumn some coast much nearer to you than Felpham —</p><p>
...
const demoPage2 = `<p>possibly, fix on any Plan of Conduct towards you, that would entirely tranquillize my Mind. This I should not so much regard, were it not for very particular Circumstances.</p>
...
export const regular = () => ({
  ...
  data: function() {
    return {
      ...
      transcriptPageTexts: [demoPage1, demoPage2, demoPage3, demoPage4]
    };
  },
  template:
